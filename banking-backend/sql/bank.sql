CREATE DATABASE  IF NOT EXISTS `bank1` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `bank1`;
...
INSERT INTO `from` VALUES ('acc1',800),('acc2',5200),('acc3',10000);
...
CREATE TABLE `money_transfer` (
  ...
  CONSTRAINT `from_account` FOREIGN KEY (`from_account`) REFERENCES `from` (`identifier`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `to_account` FOREIGN KEY (`to_account`) REFERENCES `from` (`identifier`) ON DELETE NO ACTION ON UPDATE NO ACTION
